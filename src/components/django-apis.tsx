...
const DjangoAPI = () => {
    const djangoApis = `from rest_framework.views import APIView
...
class LungCancerCTCheck(APIView):
  ...
  return (
    <div>
        <h1 className="text-3xl font-semibold tracking-tight">Building REST APIs with Django's DjangoRESTFramework</h1>
        <p className="text-sm font-normal tracking-normal leading-tight whitespace-normal">Connecting the trained model in a django API to make a full stack application with proper views, utility functions, data classes and model communications</p>
