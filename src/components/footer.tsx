  ...
  <div className="mx-auto max-w-full space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        TensorFlow and Keras, enabling accurate diagnosis from medical scans. Developed with Django, DRF, and React (Vite) for a seamless UI, integrating React Query, Ant Design, Framer Motion, and Tailwind CSS. Deployed with Docker and Appwrite Cloud Storage for scalability and security.
        </p>
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
            <li>
              <Link to="https://xcontour.vercel.app" className="text-muted-foreground transition hover:opacity-75">Contract Management Tool</Link>
            </li>

            <li>
              <Link to="https://voiquix.vercel.app" className="text-muted-foreground transition hover:opacity-75">AI Tutoring System</Link>
            </li>
    ...
    <p className="text-xs text-muted-foreground">&copy; {getFullyear}.Emmanuel Solutions - AI Projects. All rights reserved.</p>
  </div>
</footer>
  )
}
